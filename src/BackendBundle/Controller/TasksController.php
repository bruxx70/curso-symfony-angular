...
class TasksController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tasks = $em->getRepository('BackendBundle:Tasks')->findAll();
    ...
    {
        $task = new Tasks();
        $form = $this->createForm('BackendBundle\Form\TasksType', $task);
     ...
     *
     * @Route("/edit/{id}", name="tasks_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Tasks $task)
    {
        $deleteForm = $this->createDeleteForm($task);
        $editForm = $this->createForm('BackendBundle\Form\TasksType', $task);
